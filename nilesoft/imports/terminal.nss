// Windows Terminal directly in main context menu
item(type='*' where=(sel.count or wnd.is_taskbar or wnd.is_edit) and package.exists("WindowsTerminal") 
	title="Open in Terminal" 
	tip=["\xE1A7 Press SHIFT key to run as administrator", tip.warning, 1.0]
...
// Other terminals in submenu
menu(type='*' where=(sel.count or wnd.is_taskbar or wnd.is_edit) title=title.terminal image=icon.run_with_powershell)
{
