// Go To menu with remaining items
...
// Folder menu directly below Go To in main context menu
menu(type='*' where=window.is_taskbar||sel.count mode=mode.multiple title='Folder' image=\uE1F4)
{
